...
changelog = {"Date":"Modifications",
             "25/07/2016":["Modification du module MAL: Il télécgarge désomais les covers des animés automatiquement"],
             "24/07/2016":["Lors du remplissage des informations par MyanimeList, la cover de l'animé est téléchargée"],
             "23/07/2016":["Ajout d'icones sur les boutons et les onglets",
                           "Ajout d'un bouton qui permet d'afficher ses animés préférés d'un seul clic"],
             "20/07/2016":["Correction du bug de texte dans l'entrée MAL",
                           "Ajout d'une entrée Ajouté le dans les informations des animés"],
             "09/07/2016":["Ajout d'une barre de recherche pour parcourir les animés",
                           ...
                           "code: 426 lignes"],
             "07/07/2016":["Désormais l'application demandera à sauvegarder les données uniquement si quelque chose a été modifié depuis l'ouverture"],
             "05/07/2016":["Correction de bug: Les tranches d'heures sont numérotées a partir de 1 désormais",
             ...
             "04/07/2016":["Depuis l'ongelt planning, il suffit de cliquer dans la liste des animés a voir pour l'ajouter dans le journal",
             ...
             "03/07/2016":["Dans l'onglet planning, il est désormais possible de voir les animés en cours. Pratique pour savoir ou l'on en est"],
             "28/06/2016":["Mise a jour de l'interface",
                           "Ajout d'une fonction de calcul des animés"],
             "26/06/2016":["Correction du bug qui empéchait l'enregistrement final (commit de la bdd)",
             ...
             "19/06/2016":["Changement de l'interface: Passage a une interface a onglet pour acceuillir les futures fonctions"],
             "12/06/2016":["Utilisation de pyQt car je ne voulais pas utiliser Tkinter"]}
...
class Menu(PyQt4.QtGui.QMainWindow, PyQt4.uic.loadUiType("./data/gui.ui")[0]): # Chargement des interfaces depuis les fichiers
    ...
    # Fonction qui permet de remplir le texte de l'onglet "A propos"
    def a_propos(self):
        pp = pprint.PrettyPrinter(indent=2)
        strChangelog = pprint.pformat(changelog)
        strChangelog = strChangelog.translate(None, "\"'{}[]\\,").strip("Date: Modifications")
        self.plainTextEdit.setPlainText(strChangelog)
